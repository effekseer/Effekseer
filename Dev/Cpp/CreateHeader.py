...
effekseerInternalHeader.addLine('#ifdef __EFFEKSEER_BUILD_VERSION16__')
effekseerInternalHeader.addLine('#include "../Effekseer/Effekseer/Effekseer.EffectNodeModel.h"')
effekseerInternalHeader.addLine('#endif')
