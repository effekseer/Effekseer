...
struct VS_ConstantBuffer_1_1 {
  _263_mCamera : mat4x4<f32>,
  _263_mCameraProj : mat4x4<f32>,
  _263_mUVInversed : vec4<f32>,
  _263_flipbookParameter1 : vec4<f32>,
  _263_flipbookParameter2 : vec4<f32>,
}
...
fn main_inner(v_9 : vec3<f32>, v_10 : vec4<f32>, v_11 : vec2<f32>, v_12 : vec4<f32>, v_13 : vec2<f32>, v_14 : vec4<f32>, v_15 : f32, v_16 : f32) {
  var stage_input : SPIRV_Cross_Input;
  var flattenTemp : SPIRV_Cross_Output;
  var param : SPIRV_Cross_Input;
  stage_input.Input_Pos = v_9;
  stage_input.Input_Color = v_10;
  stage_input.Input_UV = v_11;
  stage_input.Input_Alpha_Dist_UV = v_12;
  stage_input.Input_BlendUV = v_13;
  stage_input.Input_Blend_Alpha_Dist_UV = v_14;
  stage_input.Input_FlipbookIndex = v_15;
  stage_input.Input_AlphaThreshold = v_16;
  param = stage_input;
...
fn v_22(vsinput : ptr<function, VS_Input>, vsoutput : ptr<function, VS_Output>) {
  ...
  (*(vsoutput)).Alpha_Dist_UV.y = (v._263_mUVInversed.x + (v._263_mUVInversed.y * (*(vsinput)).Alpha_Dist_UV.y));
  (*(vsoutput)).Alpha_Dist_UV.w = (v._263_mUVInversed.x + (v._263_mUVInversed.y * (*(vsinput)).Alpha_Dist_UV.w));
  (*(vsoutput)).Blend_FBNextIndex_UV.x = (*(vsinput)).BlendUV.x;
  (*(vsoutput)).Blend_FBNextIndex_UV.y = (*(vsinput)).BlendUV.y;
  (*(vsoutput)).Blend_FBNextIndex_UV.y = (v._263_mUVInversed.x + (v._263_mUVInversed.y * (*(vsinput)).BlendUV.y));
  (*(vsoutput)).Blend_Alpha_Dist_UV = (*(vsinput)).Blend_Alpha_Dist_UV;
  (*(vsoutput)).Blend_Alpha_Dist_UV.y = (v._263_mUVInversed.x + (v._263_mUVInversed.y * (*(vsinput)).Blend_Alpha_Dist_UV.y));
  (*(vsoutput)).Blend_Alpha_Dist_UV.w = (v._263_mUVInversed.x + (v._263_mUVInversed.y * (*(vsinput)).Blend_Alpha_Dist_UV.w));
  flipbookRate = 0.0f;
  flipbookNextIndexUV = vec2<f32>();
  param = flipbookRate;
  param_1 = flipbookNextIndexUV;
  param_2 = v._263_flipbookParameter1;
  param_3 = v._263_flipbookParameter2;
  param_4 = (*(vsinput)).FlipbookIndex;
  param_5 = (*(vsoutput)).UV_Others.xy;
  param_6 = v._263_mUVInversed.xy;
  param_32 = param;
  param_33 = param_1;
  param_34 = param_2;
  param_35 = param_3;
...
fn v_23(Input : ptr<function, VS_Input>) -> VS_Output {
  ...
  uv1 = (*(Input)).UV;
  uv1.y = (v._263_mUVInversed.x + (v._263_mUVInversed.y * uv1.y));
  Output.UV_Others.x = uv1.x;
  Output.UV_Others.y = uv1.y;
  worldPos = vec4<f32>((*(Input)).Pos.x, (*(Input)).Pos.y, (*(Input)).Pos.z, 1.0f);
  Output.PosVS = (v._263_mCameraProj * worldPos);
  Output.Color = (*(Input)).Color;
  param = *(Input);
  param_1 = Output;
  param_39 = param;
  param_40 = param_1;
  v_22(&(param_39), &(param_40));
  param_1 = param_40;
  Output = param_1;
...
@vertex
fn main(@location(0u) v_25 : vec3<f32>, @location(1u) v_26 : vec4<f32>, @location(2u) v_27 : vec2<f32>, @location(3u) v_28 : vec4<f32>, @location(4u) v_29 : vec2<f32>, @location(5u) v_30 : vec4<f32>, @location(6u) v_31 : f32, @location(7u) v_32 : f32) -> tint_symbol {
