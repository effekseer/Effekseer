...
fn main_inner(v_7 : vec3<f32>, v_8 : vec3<f32>, v_9 : vec3<f32>, v_10 : vec3<f32>, v_11 : vec2<f32>, v_12 : vec2<f32>, v_13 : vec4<f32>, v_14 : u32) {
  var stage_input : SPIRV_Cross_Input;
  var flattenTemp : SPIRV_Cross_Output;
  var param : SPIRV_Cross_Input;
  stage_input.Input_Pos = v_7;
  stage_input.Input_Normal = v_8;
  stage_input.Input_Binormal = v_9;
  stage_input.Input_Tangent = v_10;
  stage_input.Input_UV1 = v_11;
  stage_input.Input_UV2 = v_12;
  stage_input.Input_Color = v_13;
  stage_input.gl_InstanceIndex = v_14;
  param = stage_input;
...
fn v_16(Input : ptr<function, VS_Input>) -> VS_Output {
  var index : u32;
  ...
  Output.ProjBinormal = (v._31_mCameraProj * (worldPos + worldBinormal));
  Output.ProjTangent = (v._31_mCameraProj * (worldPos + worldTangent));
...
fn v_15(stage_input : ptr<function, SPIRV_Cross_Input>) -> SPIRV_Cross_Output {
...
@vertex
fn main(@location(0u) v_18 : vec3<f32>, @location(1u) v_19 : vec3<f32>, @location(2u) v_20 : vec3<f32>, @location(3u) v_21 : vec3<f32>, @location(4u) v_22 : vec2<f32>, @location(5u) v_23 : vec2<f32>, @location(6u) v_24 : vec4<f32>, @builtin(instance_index) v_25 : u32) -> tint_symbol {
  main_inner(v_18, v_19, v_20, v_21, v_22, v_23, v_24, v_25);
