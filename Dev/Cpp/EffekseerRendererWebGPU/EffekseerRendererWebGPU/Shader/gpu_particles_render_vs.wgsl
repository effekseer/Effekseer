...
struct cb1 {
  _121_paramData : ParameterData,
}

@group(0) @binding(1) var<uniform> v_1 : cb1;
...
struct cb0_1_1 {
  _136_constants : RenderConstants_1_1,
}

@group(0) @binding(0) var<uniform> v_2 : cb0_1_1;
...
struct cb2_1_1 {
  _265_emitter : EmitterData_1_1,
}

@group(0) @binding(2) var<uniform> v_3 : cb2_1_1;

struct Trails {
  m : array<u32>,
}

@group(1) @binding(1) var<storage, read> Trails_1 : Trails;

@group(1) @binding(0) var<storage, read> Particles : Trails;
...
fn v_35(particle : ptr<function, ParticleData>, position : ptr<function, vec3<f32>>, uv : ptr<function, vec2<f32>>, instanceID : ptr<function, u32>, vertexID : ptr<function, u32>) {
  ...
  var trailLength : u32;
  var segmentID : u32;
  var trailPosition : vec3<f32>;
  var param : u32;
  var trailDirection : vec3<f32>;
  var param_11 : u32;
  var trailID : u32;
  var _299 : TrailData;
  ...
  var param_1 : u32;
  var param_12 : u32;
  var trailTangent : vec3<f32>;
  updateCount = (((*(particle)).FlagBits >> 1u) & 255u);
  trailLength = min(v_1._121_paramData.ShapeData, updateCount);
  segmentID = min((*(vertexID) / 2u), trailLength);
  if ((segmentID == 0u)) {
...
fn v_39(_input : ptr<function, VS_Input>) -> VS_Output {
  ...
  var param_13 : ParticleData;
  var param_14 : vec3<f32>;
  var param_2 : ParticleData;
  var param_3 : vec3<f32>;
  var param_15 : ParticleData;
  var param_16 : vec3<f32>;
  var param_4 : ParticleData;
  var param_5 : vec3<f32>;
  var param_6 : vec2<f32>;
  var param_7 : u32;
  var param_8 : u32;
  var param_17 : ParticleData;
  ...
  _349.Seed = Particles.m[bitcast<i32>((((index * 80u) + 4u) >> bitcast<u32>(2i)))];
  _349.LifeAge = bitcast<f32>(Particles.m[bitcast<i32>((((index * 80u) + 8u) >> bitcast<u32>(2i)))]);
  _349.InheritColor = Particles.m[bitcast<i32>((((index * 80u) + 12u) >> bitcast<u32>(2i)))];
  _349.Color = Particles.m[bitcast<i32>((((index * 80u) + 16u) >> bitcast<u32>(2i)))];
  ...
  if (((particle.FlagBits & 1u) != 0u)) {
    ...
    if ((v_1._121_paramData.ShapeType == 0u)) {
      ...
      param_5 = position;
      param_6 = uv;
      param_7 = (*(_input)).InstanceID;
      param_8 = (*(_input)).VertexID;
      param_17 = param_4;
      param_18 = param_5;
      param_19 = param_6;
      param_20 = param_7;
    ...
    if ((v_1._121_paramData.MaterialType == 1u)) {
      ...
      _output.WorldB = vec3<f32>();
      _output.WorldT = vec3<f32>();
    }
  }
  return _output;
}
