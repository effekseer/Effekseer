...
struct VS_ConstantBuffer_1_1 {
  _372_mCameraProj : mat4x4<f32>,
  _372_mModel_Inst : array<mat4x4<f32>, 40u>,
  _372_fUV : array<vec4<f32>, 40u>,
  _372_fAlphaUV : array<vec4<f32>, 40u>,
  _372_fUVDistortionUV : array<vec4<f32>, 40u>,
  _372_fBlendUV : array<vec4<f32>, 40u>,
  _372_fBlendAlphaUV : array<vec4<f32>, 40u>,
  _372_fBlendUVDistortionUV : array<vec4<f32>, 40u>,
  _372_flipbookParameter1 : vec4<f32>,
  _372_flipbookParameter2 : vec4<f32>,
  _372_fFlipbookIndexAndNextRate : array<vec4<f32>, 40u>,
  _372_fModelAlphaThreshold : array<vec4<f32>, 40u>,
  _372_fModelColor : array<vec4<f32>, 40u>,
  _372_fLightDirection : vec4<f32>,
  _372_fLightColor : vec4<f32>,
  _372_fLightAmbient : vec4<f32>,
  _372_mUVInversed : vec4<f32>,
}
...
fn main_inner(v_9 : vec3<f32>, v_10 : vec3<f32>, v_11 : vec3<f32>, v_12 : vec3<f32>, v_13 : vec2<f32>, v_14 : vec2<f32>, v_15 : vec4<f32>, v_16 : u32) {
  var stage_input : SPIRV_Cross_Input;
  var flattenTemp : SPIRV_Cross_Output;
  var param : SPIRV_Cross_Input;
  stage_input.Input_Pos = v_9;
  stage_input.Input_Normal = v_10;
  stage_input.Input_Binormal = v_11;
  stage_input.Input_Tangent = v_12;
  stage_input.Input_UV1 = v_13;
  stage_input.Input_UV2 = v_14;
  stage_input.Input_Color = v_15;
  stage_input.gl_InstanceIndex = v_16;
  param = stage_input;
  ...
  v_4 = flattenTemp._entryPointOutput_Alpha_Dist_UV;
  v_5 = flattenTemp._entryPointOutput_Blend_Alpha_Dist_UV;
  v_6 = flattenTemp._entryPointOutput_Blend_FBNextIndex_UV;
  v_7 = flattenTemp._entryPointOutput_PosP;
  v_8 = flattenTemp.gl_Position;
}

fn v_18(x : ptr<function, f32>, y : ptr<function, f32>) -> f32 {
  return (*(x) - (*(y) * floor((*(x) / *(y)))));
}

fn v_19(FlipbookUV : ptr<function, vec2<f32>>, FlipbookIndex : ptr<function, f32>, DivideX : ptr<function, f32>, flipbookOneSize : ptr<function, vec2<f32>>, flipbookOffset : ptr<function, vec2<f32>>) -> vec2<f32> {
...
fn v_20(OriginUV : ptr<function, vec2<f32>>, Index : ptr<function, f32>, DivideX : ptr<function, f32>, flipbookOneSize : ptr<function, vec2<f32>>, flipbookOffset : ptr<function, vec2<f32>>) -> vec2<f32> {
  var DivideIndex : vec2<f32>;
...
fn v_21(flipbookRate : ptr<function, f32>, flipbookUV : ptr<function, vec2<f32>>, flipbookParameter1 : ptr<function, vec4<f32>>, flipbookParameter2 : ptr<function, vec4<f32>>, flipbookIndex : ptr<function, f32>, uv : ptr<function, vec2<f32>>, uvInversed : ptr<function, vec2<f32>>) {
  ...
  if ((flipbookEnabled > 0.0f)) {
    *(flipbookRate) = fract(*(flipbookIndex));
    ...
    param_25 = param_3;
    param_26 = param_4;
    OriginUV = v_19(&(param_22), &(param_23), &(param_24), &(param_25), &(param_26));
    param_5 = OriginUV;
    param_6 = NextIndex;
    param_7 = divideX;
    ...
    param_30 = param_8;
    param_31 = param_9;
    *(flipbookUV) = v_20(&(param_27), &(param_28), &(param_29), &(param_30), &(param_31));
...
fn v_22(uv : ptr<function, vec2<f32>>, uv1 : ptr<function, vec2<f32>>, alphaUV : ptr<function, vec4<f32>>, uvDistortionUV : ptr<function, vec4<f32>>, blendUV : ptr<function, vec4<f32>>, blendAlphaUV : ptr<function, vec4<f32>>, blendUVDistortionUV : ptr<function, vec4<f32>>, flipbookIndexAndNextRate : ptr<function, f32>, modelAlphaThreshold : ptr<function, f32>, vsoutput : ptr<function, VS_Output>) {
  ...
  param_2 = v._372_flipbookParameter1;
  param_3 = v._372_flipbookParameter2;
  param_4 = *(flipbookIndexAndNextRate);
  param_5 = *(uv1);
  param_6 = v._372_mUVInversed.xy;
  param_32 = param;
  param_33 = param_1;
  param_34 = param_2;
  param_35 = param_3;
  ...
  param_37 = param_5;
  param_38 = param_6;
  v_21(&(param_32), &(param_33), &(param_34), &(param_35), &(param_36), &(param_37), &(param_38));
  param = param_32;
  param_1 = param_33;
  flipbookRate = param;
  ...
  (*(vsoutput)).Alpha_Dist_UV.y = (v._372_mUVInversed.x + (v._372_mUVInversed.y * (*(vsoutput)).Alpha_Dist_UV.y));
  (*(vsoutput)).Alpha_Dist_UV.w = (v._372_mUVInversed.x + (v._372_mUVInversed.y * (*(vsoutput)).Alpha_Dist_UV.w));
  (*(vsoutput)).Blend_FBNextIndex_UV.y = (v._372_mUVInversed.x + (v._372_mUVInversed.y * (*(vsoutput)).Blend_FBNextIndex_UV.y));
  (*(vsoutput)).Blend_Alpha_Dist_UV.y = (v._372_mUVInversed.x + (v._372_mUVInversed.y * (*(vsoutput)).Blend_Alpha_Dist_UV.y));
  (*(vsoutput)).Blend_Alpha_Dist_UV.w = (v._372_mUVInversed.x + (v._372_mUVInversed.y * (*(vsoutput)).Blend_Alpha_Dist_UV.w));
}
...
fn v_23(Input : ptr<function, VS_Input>) -> VS_Output {
  var index : u32;
  var mModel : mat4x4<f32>;
  var uv : vec4<f32>;
  var alphaUV : vec4<f32>;
  var uvDistortionUV : vec4<f32>;
  var blendUV : vec4<f32>;
  var blendAlphaUV : vec4<f32>;
  var blendUVDistortionUV : vec4<f32>;
  var modelColor : vec4<f32>;
  var flipbookIndexAndNextRate : f32;
  var modelAlphaThreshold : f32;
  ...
  var param_46 : f32;
  var param_47 : f32;
  var param_48 : VS_Output;
  index = (*(Input)).Index;
  mModel = v._372_mModel_Inst[index];
  uv = v._372_fUV[index];
  alphaUV = v._372_fAlphaUV[index];
  uvDistortionUV = v._372_fUVDistortionUV[index];
  blendUV = v._372_fBlendUV[index];
  blendAlphaUV = v._372_fBlendAlphaUV[index];
  blendUVDistortionUV = v._372_fBlendUVDistortionUV[index];
  modelColor = (v._372_fModelColor[index] * (*(Input)).Color);
  flipbookIndexAndNextRate = v._372_fFlipbookIndexAndNextRate[index].x;
  modelAlphaThreshold = v._372_fModelAlphaThreshold[index].x;
  ...
  localPosition = vec4<f32>((*(Input)).Pos.x, (*(Input)).Pos.y, (*(Input)).Pos.z, 1.0f);
  worldPos = (mModel * localPosition);
  Output.PosVS = (v._372_mCameraProj * worldPos);
  outputUV = (*(Input)).UV1;
  outputUV.x = ((outputUV.x * uv.z) + uv.x);
  outputUV.y = ((outputUV.y * uv.w) + uv.y);
  outputUV.y = (v._372_mUVInversed.x + (v._372_mUVInversed.y * outputUV.y));
  ...
  param = (*(Input)).UV1;
  param_1 = Output.UV_Others.xy;
  param_2 = alphaUV;
  param_3 = uvDistortionUV;
  param_4 = blendUV;
  param_5 = blendAlphaUV;
  param_6 = blendUVDistortionUV;
  param_7 = flipbookIndexAndNextRate;
  param_8 = modelAlphaThreshold;
  param_9 = Output;
  param_39 = param;
  param_40 = param_1;
  param_41 = param_2;
  ...
  param_47 = param_8;
  param_48 = param_9;
  v_22(&(param_39), &(param_40), &(param_41), &(param_42), &(param_43), &(param_44), &(param_45), &(param_46), &(param_47), &(param_48));
  param_9 = param_48;
  Output = param_9;
...
fn v_17(stage_input : ptr<function, SPIRV_Cross_Input>) -> SPIRV_Cross_Output {
...
@vertex
fn main(@location(0u) v_25 : vec3<f32>, @location(1u) v_26 : vec3<f32>, @location(2u) v_27 : vec3<f32>, @location(3u) v_28 : vec3<f32>, @location(4u) v_29 : vec2<f32>, @location(5u) v_30 : vec2<f32>, @location(6u) v_31 : vec4<f32>, @builtin(instance_index) v_32 : u32) -> tint_symbol {
  main_inner(v_25, v_26, v_27, v_28, v_29, v_30, v_31, v_32);
  return tint_symbol(v_1, v_2, v_3, v_4, v_5, v_6, v_7, v_8);
}
