...
struct PS_ConstantBuffer {
  _434_fLightDirection : vec4<f32>,
  _434_fLightColor : vec4<f32>,
  _434_fLightAmbient : vec4<f32>,
  _434_fFlipbookParameter : vec4<f32>,
  _434_fUVDistortionParameter : vec4<f32>,
  _434_fBlendTextureParameter : vec4<f32>,
  _434_fCameraFrontDirection : vec4<f32>,
  _434_fFalloffParameter : vec4<f32>,
  _434_fFalloffBeginColor : vec4<f32>,
  _434_fFalloffEndColor : vec4<f32>,
  _434_fEmissiveScaling : vec4<f32>,
  _434_fEdgeColor : vec4<f32>,
  _434_fEdgeParameter : vec4<f32>,
  _434_softParticleParam : vec4<f32>,
  _434_reconstructionParam1 : vec4<f32>,
  _434_reconstructionParam2 : vec4<f32>,
  _434_mUVInversedBack : vec4<f32>,
  _434_miscFlags : vec4<f32>,
}
...
fn main_inner(v_2 : vec4<f32>, v_3 : vec4<f32>, v_4 : vec3<f32>, v_5 : vec3<f32>, v_6 : vec3<f32>, v_7 : vec4<f32>, v_8 : vec4<f32>, v_9 : vec4<f32>, v_10 : vec4<f32>, v_11 : vec4<f32>) {
  ...
  stage_input.Input_PosP = v_10;
  stage_input.gl_FragCoord = v_11;
  param = stage_input;
  v_1 = v_12(&(param))._entryPointOutput;
}
...
fn v_13(psinput : ptr<function, PS_Input>) -> AdvancedParameter {
...
fn v_14(base : ptr<function, vec3<f32>>, power : ptr<function, vec3<f32>>) -> vec3<f32> {
  return pow(max(abs(*(base)), vec3<f32>(0.00000011920928955078f)), *(power));
}

fn v_15(c : ptr<function, vec3<f32>>) -> vec3<f32> {
  var param : vec3<f32>;
  ...
  param_26 = param;
  param_27 = param_1;
  return max(((v_14(&(param_26), &(param_27)) * 1.05499994754791259766f) - vec3<f32>(0.05499999970197677612f)), vec3<f32>());
}

fn v_16(c : ptr<function, vec4<f32>>) -> vec4<f32> {
  var param : vec3<f32>;
  var param_28 : vec3<f32>;
  param = (*(c)).xyz;
  param_28 = param;
  let v_17 = v_15(&(param_28));
  return vec4<f32>(v_17.x, v_17.y, v_17.z, (*(c)).w);
}

fn v_18(c : ptr<function, vec4<f32>>, isValid : ptr<function, bool>) -> vec4<f32> {
  var param : vec4<f32>;
...
fn v_19(uv : ptr<function, vec2<f32>>, uvInversed : ptr<function, vec2<f32>>, convertFromSRGB : ptr<function, bool>) -> vec2<f32> {
  ...
  if (*(convertFromSRGB)) {
    ...
    param_30 = param;
    param_31 = param_1;
    sampledColor = v_18(&(param_30), &(param_31));
  }
...
fn v_20(uv : ptr<function, vec2<f32>>, uvInversed : ptr<function, vec2<f32>>, convertFromSRGB : ptr<function, bool>) -> vec2<f32> {
  var sampledColor : vec4<f32>;
  var param : vec4<f32>;
  var param_1 : bool;
  ...
  if (*(convertFromSRGB)) {
    ...
    param_32 = param;
    param_33 = param_1;
    sampledColor = v_18(&(param_32), &(param_33));
  }
  UVOffset = ((sampledColor.xy * 2.0f) - vec2<f32>(1.0f));
  UVOffset.y = (UVOffset.y * -1.0f);
  UVOffset.y = ((*(uvInversed)).x + ((*(uvInversed)).y * UVOffset.y));
...
fn v_21(dst : ptr<function, vec4<f32>>, flipbookParameter : ptr<function, vec4<f32>>, vcolor : ptr<function, vec4<f32>>, nextUV : ptr<function, vec2<f32>>, flipbookRate : ptr<function, f32>, convertFromSRGB : ptr<function, bool>) {
  var sampledColor : vec4<f32>;
  var param : vec4<f32>;
  var param_1 : bool;
  ...
  if (((*(flipbookParameter)).x > 0.0f)) {
    ...
    if (*(convertFromSRGB)) {
      ...
      param_34 = param;
      param_35 = param_1;
      sampledColor = v_18(&(param_34), &(param_35));
    }
    NextPixelColor = (sampledColor * *(vcolor));
    if (((*(flipbookParameter)).y == 1.0f)) {
      let v_22 = *(dst);
      let v_23 = NextPixelColor;
      let v_24 = *(flipbookRate);
      *(dst) = mix(v_22, v_23, vec4<f32>(v_24, v_24, v_24, v_24));
    }
  }
}

fn v_25(dstColor : ptr<function, vec4<f32>>, blendColor : ptr<function, vec4<f32>>, blendType : ptr<function, f32>) {
  var _219 : vec4<f32>;
  var _222 : vec3<f32>;
  var _237 : vec4<f32>;
  var _239 : vec3<f32>;
...
fn v_26(backgroundZ : ptr<function, f32>, meshZ : ptr<function, f32>, softparticleParam : ptr<function, vec4<f32>>, reconstruct1 : ptr<function, vec4<f32>>, reconstruct2 : ptr<function, vec4<f32>>) -> f32 {
  var distanceFar : f32;
  ...
  let v_27 = (zs * params.w);
  let v_28 = params.y;
  let v_29 = params.x;
  depth = ((v_27 - vec2<f32>(v_28, v_28)) / (vec2<f32>(v_29, v_29) - (zs * params.z)));
  dir = sign(depth.x);
  let v_30 = dir;
  depth = (depth * v_30);
...
fn v_31(c : ptr<function, vec3<f32>>) -> vec3<f32> {
  return min(*(c), (*(c) * ((*(c) * ((*(c) * 0.30530601739883422852f) + vec3<f32>(0.68217110633850097656f))) + vec3<f32>(0.01252287812530994415f))));
}

fn v_32(c : ptr<function, vec4<f32>>) -> vec4<f32> {
  var param : vec3<f32>;
  var param_36 : vec3<f32>;
  param = (*(c)).xyz;
  param_36 = param;
  let v_33 = v_31(&(param_36));
  return vec4<f32>(v_33.x, v_33.y, v_33.z, (*(c)).w);
}

fn v_34(c : ptr<function, vec4<f32>>, isValid : ptr<function, bool>) -> vec4<f32> {
  var param : vec4<f32>;
  ...
  param = *(c);
  param_37 = param;
  return v_32(&(param_37));
}

fn v_35(Input : ptr<function, PS_Input>) -> vec4<f32> {
  ...
  var param_68 : bool;
  convertColorSpace = !((v._434_miscFlags.x == 0.0f));
  param = *(Input);
  param_38 = param;
  advancedParam = v_13(&(param_38));
  param_1 = advancedParam.UVDistortionUV;
  param_2 = v._434_fUVDistortionParameter.zw;
  param_3 = convertColorSpace;
  param_39 = param_1;
  param_40 = param_2;
  param_41 = param_3;
  UVOffset = v_19(&(param_39), &(param_40), &(param_41));
  let v_36 = v._434_fUVDistortionParameter.x;
  UVOffset = (UVOffset * v_36);
  param_4 = textureSample(_colorTex, sampler_colorTex, ((*(Input)).UV_Others.xy + UVOffset));
  param_5 = convertColorSpace;
  param_42 = param_4;
  param_43 = param_5;
  Output = (v_18(&(param_42), &(param_43)) * (*(Input)).Color);
  texNormal = ((textureSample(_normalTex, sampler_normalTex, ((*(Input)).UV_Others.xy + UVOffset)).xyz - vec3<f32>(0.5f)) * 2.0f);
  let v_37 = (*(Input)).WorldT;
  let v_38 = (*(Input)).WorldB;
  let v_39 = (*(Input)).WorldN;
  localNormal = normalize((mat3x3<f32>(vec3<f32>(v_37.x, v_37.y, v_37.z), vec3<f32>(v_38.x, v_38.y, v_38.z), vec3<f32>(v_39.x, v_39.y, v_39.z)) * texNormal));
  param_6 = Output;
  param_7 = advancedParam.FlipbookRate;
  param_8 = convertColorSpace;
  let v_40 = (advancedParam.FlipbookNextIndexUV + UVOffset);
  param_44 = param_6;
  param_45 = v._434_fFlipbookParameter;
  param_46 = (*(Input)).Color;
  param_47 = v_40;
  param_48 = param_7;
  param_49 = param_8;
  v_21(&(param_44), &(param_45), &(param_46), &(param_47), &(param_48), &(param_49));
  param_6 = param_44;
  Output = param_6;
  ...
  param_50 = param_9;
  param_51 = param_10;
  AlphaTexColor = v_18(&(param_50), &(param_51));
  let v_41 = (AlphaTexColor.x * AlphaTexColor.w);
  Output.w = (Output.w * v_41);
  param_11 = advancedParam.BlendUVDistortionUV;
  param_12 = v._434_fUVDistortionParameter.zw;
  param_13 = convertColorSpace;
  param_52 = param_11;
  param_53 = param_12;
  param_54 = param_13;
  BlendUVOffset = v_20(&(param_52), &(param_53), &(param_54));
  let v_42 = v._434_fUVDistortionParameter.y;
  BlendUVOffset = (BlendUVOffset * v_42);
  param_14 = textureSample(_blendTex, sampler_blendTex, (advancedParam.BlendUV + BlendUVOffset));
  param_15 = convertColorSpace;
  param_55 = param_14;
  param_56 = param_15;
  BlendTextureColor = v_18(&(param_55), &(param_56));
  ...
  param_57 = param_16;
  param_58 = param_17;
  BlendAlphaTextureColor = v_18(&(param_57), &(param_58));
  let v_43 = (BlendAlphaTextureColor.x * BlendAlphaTextureColor.w);
  BlendTextureColor.w = (BlendTextureColor.w * v_43);
  param_18 = Output;
  param_59 = param_18;
  param_60 = BlendTextureColor;
  param_61 = v._434_fBlendTextureParameter.x;
  v_25(&(param_59), &(param_60), &(param_61));
  param_18 = param_59;
  Output = param_18;
  diffuse = max(dot(v._434_fLightDirection.xyz, localNormal), 0.0f);
  _633 = Output;
  _644 = (_633.xyz * ((v._434_fLightColor.xyz * diffuse) + v._434_fLightAmbient.xyz));
  Output.x = _644.x;
  Output.y = _644.y;
  Output.z = _644.z;
  if ((v._434_fFalloffParameter.x == 1.0f)) {
    cameraVec = normalize(-(v._434_fCameraFrontDirection.xyz));
    CdotN = clamp(dot(cameraVec, vec3<f32>(localNormal.x, localNormal.y, localNormal.z)), 0.0f, 1.0f);
    let v_44 = v._434_fFalloffEndColor;
    let v_45 = v._434_fFalloffBeginColor;
    let v_46 = pow(CdotN, v._434_fFalloffParameter.z);
    FalloffBlendColor = mix(v_44, v_45, vec4<f32>(v_46, v_46, v_46, v_46));
    if ((v._434_fFalloffParameter.y == 0.0f)) {
      _692 = Output;
      _694 = (_692.xyz + FalloffBlendColor.xyz);
      Output.x = _694.x;
      Output.y = _694.y;
      Output.z = _694.z;
    } else if ((v._434_fFalloffParameter.y == 1.0f)) {
      _709 = Output;
      _711 = (_709.xyz - FalloffBlendColor.xyz);
      Output.x = _711.x;
      Output.y = _711.y;
      Output.z = _711.z;
    } else if ((v._434_fFalloffParameter.y == 2.0f)) {
      _726 = Output;
      _728 = (_726.xyz * FalloffBlendColor.xyz);
      Output.x = _728.x;
      Output.y = _728.y;
      Output.z = _728.z;
    }
    let v_47 = FalloffBlendColor.w;
    Output.w = (Output.w * v_47);
  }
  _744 = Output;
  _746 = (_744.xyz * v._434_fEmissiveScaling.x);
  Output.x = _746.x;
  Output.y = _746.y;
  Output.z = _746.z;
  let v_48 = (*(Input)).PosP;
  let v_49 = (*(Input)).PosP.w;
  screenPos = (v_48 / vec4<f32>(v_49, v_49, v_49, v_49));
  screenUV = ((screenPos.xy + vec2<f32>(1.0f)) / vec2<f32>(2.0f));
  screenUV.y = (1.0f - screenUV.y);
  screenUV.y = (v._434_mUVInversedBack.x + (v._434_mUVInversedBack.y * screenUV.y));
  if (!((v._434_softParticleParam.w == 0.0f))) {
    backgroundZ = textureSample(_depthTex, sampler_depthTex, screenUV).x;
    param_19 = backgroundZ;
    param_20 = screenPos.z;
    param_21 = v._434_softParticleParam;
    param_22 = v._434_reconstructionParam1;
    param_23 = v._434_reconstructionParam2;
    param_62 = param_19;
    param_63 = param_20;
    param_64 = param_21;
    param_65 = param_22;
    param_66 = param_23;
    let v_50 = v_26(&(param_62), &(param_63), &(param_64), &(param_65), &(param_66));
    Output.w = (Output.w * v_50);
  }
  ...
  _832 = Output;
  _835 = Output.w;
  let v_51 = (v._434_fEdgeColor.xyz * v._434_fEdgeParameter.y);
  let v_52 = _832.xyz;
  let v_53 = ceil(((_835 - advancedParam.AlphaThreshold) - v._434_fEdgeParameter.x));
  _844 = mix(v_51, v_52, vec3<f32>(v_53, v_53, v_53));
  Output.x = _844.x;
  Output.y = _844.y;
  Output.z = _844.z;
  param_24 = Output;
...
fn v_12(stage_input : ptr<function, SPIRV_Cross_Input>) -> SPIRV_Cross_Output {
...
@fragment
fn main(@location(0u) @interpolate(perspective, centroid) v_55 : vec4<f32>, @location(1u) @interpolate(perspective, centroid) v_56 : vec4<f32>, @location(2u) v_57 : vec3<f32>, @location(3u) v_58 : vec3<f32>, @location(4u) v_59 : vec3<f32>, @location(5u) v_60 : vec4<f32>, @location(6u) v_61 : vec4<f32>, @location(7u) v_62 : vec4<f32>, @location(8u) v_63 : vec4<f32>, @builtin(position) v_64 : vec4<f32>) -> @location(0u) vec4<f32> {
  main_inner(v_55, v_56, v_57, v_58, v_59, v_60, v_61, v_62, v_63, v_64);
  return v_1;
}
