...
fn main_inner(v_11 : vec3<f32>, v_12 : vec3<f32>, v_13 : vec3<f32>, v_14 : vec3<f32>, v_15 : vec2<f32>, v_16 : vec2<f32>, v_17 : vec4<f32>, v_18 : u32) {
...
fn v_20(x : ptr<function, f32>, y : ptr<function, f32>) -> f32 {
  return (*(x) - (*(y) * floor((*(x) / *(y)))));
}

fn v_21(FlipbookUV : ptr<function, vec2<f32>>, FlipbookIndex : ptr<function, f32>, DivideX : ptr<function, f32>, flipbookOneSize : ptr<function, vec2<f32>>, flipbookOffset : ptr<function, vec2<f32>>) -> vec2<f32> {
...
fn v_22(OriginUV : ptr<function, vec2<f32>>, Index : ptr<function, f32>, DivideX : ptr<function, f32>, flipbookOneSize : ptr<function, vec2<f32>>, flipbookOffset : ptr<function, vec2<f32>>) -> vec2<f32> {
  var DivideIndex : vec2<f32>;
...
fn v_23(flipbookRate : ptr<function, f32>, flipbookUV : ptr<function, vec2<f32>>, flipbookParameter1 : ptr<function, vec4<f32>>, flipbookParameter2 : ptr<function, vec4<f32>>, flipbookIndex : ptr<function, f32>, uv : ptr<function, vec2<f32>>, uvInversed : ptr<function, vec2<f32>>) {
  ...
  if ((flipbookEnabled > 0.0f)) {
    *(flipbookRate) = fract(*(flipbookIndex));
    ...
    param_25 = param_3;
    param_26 = param_4;
    OriginUV = v_21(&(param_22), &(param_23), &(param_24), &(param_25), &(param_26));
    param_5 = OriginUV;
    param_6 = NextIndex;
    param_7 = divideX;
    ...
    param_30 = param_8;
    param_31 = param_9;
    *(flipbookUV) = v_22(&(param_27), &(param_28), &(param_29), &(param_30), &(param_31));
...
fn v_24(uv : ptr<function, vec2<f32>>, uv1 : ptr<function, vec2<f32>>, alphaUV : ptr<function, vec4<f32>>, uvDistortionUV : ptr<function, vec4<f32>>, blendUV : ptr<function, vec4<f32>>, blendAlphaUV : ptr<function, vec4<f32>>, blendUVDistortionUV : ptr<function, vec4<f32>>, flipbookIndexAndNextRate : ptr<function, f32>, modelAlphaThreshold : ptr<function, f32>, vsoutput : ptr<function, VS_Output>) {
  ...
  param_37 = param_5;
  param_38 = param_6;
  v_23(&(param_32), &(param_33), &(param_34), &(param_35), &(param_36), &(param_37), &(param_38));
  param = param_32;
  param_1 = param_33;
  flipbookRate = param;
...
fn v_25(Input : ptr<function, VS_Input>) -> VS_Output {
  var index : u32;
  ...
  param_47 = param_8;
  param_48 = param_9;
  v_24(&(param_39), &(param_40), &(param_41), &(param_42), &(param_43), &(param_44), &(param_45), &(param_46), &(param_47), &(param_48));
  param_9 = param_48;
  Output = param_9;
...
@vertex
fn main(@location(0u) v_27 : vec3<f32>, @location(1u) v_28 : vec3<f32>, @location(2u) v_29 : vec3<f32>, @location(3u) v_30 : vec3<f32>, @location(4u) v_31 : vec2<f32>, @location(5u) v_32 : vec2<f32>, @location(6u) v_33 : vec4<f32>, @builtin(instance_index) v_34 : u32) -> tint_symbol {
  main_inner(v_27, v_28, v_29, v_30, v_31, v_32, v_33, v_34);
