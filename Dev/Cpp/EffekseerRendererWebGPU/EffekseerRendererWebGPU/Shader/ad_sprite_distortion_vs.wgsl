...
fn main_inner(v_10 : vec3<f32>, v_11 : vec4<f32>, v_12 : vec4<f32>, v_13 : vec4<f32>, v_14 : vec2<f32>, v_15 : vec2<f32>, v_16 : vec4<f32>, v_17 : vec2<f32>, v_18 : vec4<f32>, v_19 : f32, v_20 : f32) {
  ...
  stage_input.Input_Alpha_Dist_UV = v_16;
  stage_input.Input_BlendUV = v_17;
  stage_input.Input_Blend_Alpha_Dist_UV = v_18;
  stage_input.Input_FlipbookIndex = v_19;
  stage_input.Input_AlphaThreshold = v_20;
  param = stage_input;
  flattenTemp = v_21(&(param));
...
fn v_22(x : ptr<function, f32>, y : ptr<function, f32>) -> f32 {
  return (*(x) - (*(y) * floor((*(x) / *(y)))));
}

fn v_23(FlipbookUV : ptr<function, vec2<f32>>, FlipbookIndex : ptr<function, f32>, DivideX : ptr<function, f32>, flipbookOneSize : ptr<function, vec2<f32>>, flipbookOffset : ptr<function, vec2<f32>>) -> vec2<f32> {
...
fn v_24(OriginUV : ptr<function, vec2<f32>>, Index : ptr<function, f32>, DivideX : ptr<function, f32>, flipbookOneSize : ptr<function, vec2<f32>>, flipbookOffset : ptr<function, vec2<f32>>) -> vec2<f32> {
  var DivideIndex : vec2<f32>;
...
fn v_25(flipbookRate : ptr<function, f32>, flipbookUV : ptr<function, vec2<f32>>, flipbookParameter1 : ptr<function, vec4<f32>>, flipbookParameter2 : ptr<function, vec4<f32>>, flipbookIndex : ptr<function, f32>, uv : ptr<function, vec2<f32>>, uvInversed : ptr<function, vec2<f32>>) {
  ...
  if ((flipbookEnabled > 0.0f)) {
    *(flipbookRate) = fract(*(flipbookIndex));
    ...
    param_25 = param_3;
    param_26 = param_4;
    OriginUV = v_23(&(param_22), &(param_23), &(param_24), &(param_25), &(param_26));
    param_5 = OriginUV;
    param_6 = NextIndex;
    param_7 = divideX;
    ...
    param_30 = param_8;
    param_31 = param_9;
    *(flipbookUV) = v_24(&(param_27), &(param_28), &(param_29), &(param_30), &(param_31));
...
fn v_26(vsinput : ptr<function, VS_Input>, vsoutput : ptr<function, VS_Output>) {
  ...
  param_37 = param_5;
  param_38 = param_6;
  v_25(&(param_32), &(param_33), &(param_34), &(param_35), &(param_36), &(param_37), &(param_38));
  param = param_32;
  param_1 = param_33;
  flipbookRate = param;
...
fn v_27(Input : ptr<function, VS_Input>) -> VS_Output {
  ...
  let v_28 = (((*(Input)).Normal.xyz - vec3<f32>(0.5f)) * 2.0f);
  worldNormal = vec4<f32>(v_28.x, v_28.y, v_28.z, 0.0f);
  let v_29 = (((*(Input)).Tangent.xyz - vec3<f32>(0.5f)) * 2.0f);
  worldTangent = vec4<f32>(v_29.x, v_29.y, v_29.z, 0.0f);
  let tangentHandedness = (((*(Input)).Tangent.w * 2.0f) - 1.0f);
  let v_30 = cross(worldNormal.xyz, worldTangent.xyz) * tangentHandedness;
  worldBinormal = vec4<f32>(v_30.x, v_30.y, v_30.z, 0.0f);
  uv1 = (*(Input)).UV1;
  ...
  Output.ProjTangent = (v._262_mCameraProj * (worldPos + worldTangent));
  Output.ProjBinormal = (v._262_mCameraProj * (worldPos + worldBinormal));
  Output.Color = (*(Input)).Color;
  param = *(Input);
  param_1 = Output;
  param_39 = param;
  param_40 = param_1;
  v_26(&(param_39), &(param_40));
  param_1 = param_40;
  Output = param_1;
...
fn v_21(stage_input : ptr<function, SPIRV_Cross_Input>) -> SPIRV_Cross_Output {
...
@vertex
fn main(@location(0u) v_32 : vec3<f32>, @location(1u) v_33 : vec4<f32>, @location(2u) v_34 : vec4<f32>, @location(3u) v_35 : vec4<f32>, @location(4u) v_36 : vec2<f32>, @location(5u) v_37 : vec2<f32>, @location(6u) v_38 : vec4<f32>, @location(7u) v_39 : vec2<f32>, @location(8u) v_40 : vec4<f32>, @location(9u) v_41 : f32, @location(10u) v_42 : f32) -> tint_symbol {
  main_inner(v_32, v_33, v_34, v_35, v_36, v_37, v_38, v_39, v_40, v_41, v_42);
