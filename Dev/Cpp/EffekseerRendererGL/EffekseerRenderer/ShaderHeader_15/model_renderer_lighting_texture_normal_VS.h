static const char model_renderer_lighting_texture_normal_VS_gl2[] = R"(
#version 120
...
static const char model_renderer_lighting_texture_normal_VS_gl3[] = R"(
#version 330
#ifdef GL_ARB_shading_language_420pack
#extension GL_ARB_shading_language_420pack : require
#endif
...
VS_Output _main(VS_Input Input)
{
    ...
    vec4 localBinormal = vec4(Input.Binormal.x, Input.Binormal.y, Input.Binormal.z, 0.0);
    localBinormal = normalize(localBinormal * CBVS0.mModel);
    vec4 localTangent = vec4(Input.Tangent.x, Input.Tangent.y, Input.Tangent.z, 0.0);
    localTangent = normalize(localTangent * CBVS0.mModel);
    Output.Normal = localNormal.xyz;
    Output.Binormal = localBinormal.xyz;
    Output.Tangent = localTangent.xyz;
    Output.UV.y = CBVS0.mUVInversed.x + (CBVS0.mUVInversed.y * Output.UV.y);
...
static const char model_renderer_lighting_texture_normal_VS_gles2[] = R"(
...
static const char model_renderer_lighting_texture_normal_VS_gles3[] = R"(
#version 300 es
...
void main()
{
    ...
    static const char* get_model_renderer_lighting_texture_normal_VS (EffekseerRendererGL::OpenGLDeviceType deviceType)
    {
        if (deviceType == EffekseerRendererGL::OpenGLDeviceType::OpenGL3)
            return model_renderer_lighting_texture_normal_VS_gl3;
        if (deviceType == EffekseerRendererGL::OpenGLDeviceType::OpenGL2)
            return model_renderer_lighting_texture_normal_VS_gl2;
        if (deviceType == EffekseerRendererGL::OpenGLDeviceType::OpenGLES3)
            return model_renderer_lighting_texture_normal_VS_gles3;
        if (deviceType == EffekseerRendererGL::OpenGLDeviceType::OpenGLES2 || deviceType == EffekseerRendererGL::OpenGLDeviceType::Emscripten)
            return model_renderer_lighting_texture_normal_VS_gles2;
        return nullptr;
    }
