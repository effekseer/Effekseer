static const char standard_renderer_distortion_VS_gl2[] = R"(
#version 120
...
static const char standard_renderer_distortion_VS_gl3[] = R"(
#version 330
#ifdef GL_ARB_shading_language_420pack
#extension GL_ARB_shading_language_420pack : require
#endif
...
static const char standard_renderer_distortion_VS_gles2[] = R"(
...
static const char standard_renderer_distortion_VS_gles3[] = R"(
#version 300 es
...
void main()
{
    ...
    static const char* get_standard_renderer_distortion_VS (EffekseerRendererGL::OpenGLDeviceType deviceType)
    {
        if (deviceType == EffekseerRendererGL::OpenGLDeviceType::OpenGL3)
            return standard_renderer_distortion_VS_gl3;
        if (deviceType == EffekseerRendererGL::OpenGLDeviceType::OpenGL2)
            return standard_renderer_distortion_VS_gl2;
        if (deviceType == EffekseerRendererGL::OpenGLDeviceType::OpenGLES3)
            return standard_renderer_distortion_VS_gles3;
        if (deviceType == EffekseerRendererGL::OpenGLDeviceType::OpenGLES2 || deviceType == EffekseerRendererGL::OpenGLDeviceType::Emscripten)
            return standard_renderer_distortion_VS_gles2;
        return nullptr;
    }
