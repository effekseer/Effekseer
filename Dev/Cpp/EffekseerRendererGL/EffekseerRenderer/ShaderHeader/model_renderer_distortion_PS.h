static const char model_renderer_distortion_PS_gl2[] = R"(
#version 120
...
vec4 _main(PS_Input Input)
{
    ...
    ApplyFlipbook(param_1, CBPS0.fFlipbookParameter, Input.Color, advancedParam.FlipbookNextIndexUV + UVOffset, param_2, Sampler_g_sampler);
    Output = param_1;
...
static const char model_renderer_distortion_PS_gl3[] = R"(
#version 330
#ifdef GL_ARB_shading_language_420pack
#extension GL_ARB_shading_language_420pack : require
#endif
...
void main()
{
    ...
    Input.Blend_FBNextIndex_UV = _VSPS_Blend_FBNextIndex_UV;
    Input.Others = _VSPS_Others;
    highp vec4 _440 = _main(Input);
    gl_FragData[0] = _440;
}

)";

static const char model_renderer_distortion_PS_gles3[] = R"(
#version 300 es
precision mediump float;
precision highp int;
...
void main()
{
    ...
    static const char* get_model_renderer_distortion_PS (EffekseerRendererGL::OpenGLDeviceType deviceType)
    {
        if (deviceType == EffekseerRendererGL::OpenGLDeviceType::OpenGL3)
            return model_renderer_distortion_PS_gl3;
