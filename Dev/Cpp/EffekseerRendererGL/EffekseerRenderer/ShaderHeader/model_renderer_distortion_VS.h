static const char model_renderer_distortion_VS_gl2[] = R"(
#version 120
...
static const char model_renderer_distortion_VS_gl3[] = R"(
#version 330
#ifdef GL_ARB_shading_language_420pack
#extension GL_ARB_shading_language_420pack : require
#endif
...
VS_Output _main(VS_Input Input)
{
    ...
    vec4 modelColor = CBVS0.fModelColor[Input.Index];
...
static const char model_renderer_distortion_VS_gles3[] = R"(
#version 300 es
#ifdef GL_ARB_shader_draw_parameters
#extension GL_ARB_shader_draw_parameters : enable
#endif
...
void main()
{
    ...
    static const char* get_model_renderer_distortion_VS (EffekseerRendererGL::OpenGLDeviceType deviceType)
    {
        if (deviceType == EffekseerRendererGL::OpenGLDeviceType::OpenGL3)
            return model_renderer_distortion_VS_gl3;
        if (deviceType == EffekseerRendererGL::OpenGLDeviceType::OpenGL2)
            return model_renderer_distortion_VS_gl2;
        if (deviceType == EffekseerRendererGL::OpenGLDeviceType::OpenGLES3)
            return model_renderer_distortion_VS_gles3;
        if (deviceType == EffekseerRendererGL::OpenGLDeviceType::OpenGLES2)
            return model_renderer_distortion_VS_gles2;
        return nullptr;
    }
