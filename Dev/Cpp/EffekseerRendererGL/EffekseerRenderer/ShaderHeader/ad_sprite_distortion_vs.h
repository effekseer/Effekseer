...
VS_Output _main(VS_Input Input)
{
    ...
    vec3 _417 = localTangent.xyz + worldTangent;
    localTangent = vec4(_417.x, _417.y, _417.z, localTangent.w);
    vec3 _423 = localBinormal.xyz + worldBinormal;
    localBinormal = vec4(_423.x, _423.y, _423.z, localBinormal.w);
