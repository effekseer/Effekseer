...
{
    float4 _68_flipbookParameter : register(c0);
    float4 _68_uvDistortionParameter : register(c1);
    float4 _68_blendTextureParameter : register(c2);
    float4 _68_emissiveScaling : register(c3);
    float4 _68_edgeColor : register(c4);
    float4 _68_edgeParameter : register(c5);
};
