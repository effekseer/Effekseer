...
static const VS_Output _375 = { 0.0f.xxxx, 0.0f.xxxx, 0.0f.xxxx, 0.0f.xxx, 0.0f.xxxx, 0.0f.xxxx, 0.0f.xxxx };

cbuffer VS_ConstantBuffer : register(b0)
{
    column_major float4x4 _277_mCamera : register(c0);
    column_major float4x4 _277_mCameraProj : register(c4);
    float4 _277_mUVInversed : register(c8);
    float4 _277_fFlipbookParameter : register(c9);
};
