...
{
    column_major float4x4 _276_mCamera : register(c0);
    column_major float4x4 _276_mCameraProj : register(c4);
    float4 _276_mUVInversed : register(c8);
    float4 _276_fFlipbookParameter : register(c9);
};
