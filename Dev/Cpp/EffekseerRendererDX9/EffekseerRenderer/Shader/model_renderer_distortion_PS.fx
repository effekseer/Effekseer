...
{
    float4 _210_g_scale : register(c0);
    float4 _210_mUVInversedBack : register(c1);
    float4 _210_fFlipbookParameter : register(c2);
    float4 _210_fUVDistortionParameter : register(c3);
    float4 _210_fBlendTextureParameter : register(c4);
};
...
float4 _main(PS_Input Input)
{
    ...
    ApplyFlipbook(param_3, _210_fFlipbookParameter, Input.Color, advancedParam.FlipbookNextIndexUV + UVOffset, param_4, Sampler_g_sampler);
    Output = param_3;
