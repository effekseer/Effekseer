...
{
    column_major float4x4 _43_mCamera : register(c0);
    column_major float4x4 _43_mProj : register(c4);
    float4 _43_mUVInversed : register(c8);
    float4 _43_mflipbookParameter : register(c9);
};
