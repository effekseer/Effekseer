...
{
    float4 _186_g_scale : register(c0);
    float4 _186_mUVInversedBack : register(c1);
    float4 _186_flipbookParameter : register(c2);
    float4 _186_uvDistortionParameter : register(c3);
    float4 _186_blendTextureParameter : register(c4);
};
