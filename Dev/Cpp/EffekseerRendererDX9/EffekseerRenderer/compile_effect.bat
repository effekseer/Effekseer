...
"%DXSDK_DIR%Utilities\\bin\x86\fxc" /Zpc /Tvs_2_0 /EVS /Fh Shader/EffekseerRenderer.Standard_Lighting_VS.h Shader/standard_renderer_lighting_VS.fx
"%DXSDK_DIR%Utilities\\bin\x86\fxc" /Zpc /Tps_2_0 /EPS /Fh Shader/EffekseerRenderer.Standard_Lighting_PS.h Shader/standard_renderer_lighting_PS.fx
