"%DXSDK_DIR%Utilities\\bin\x86\fxc" /Zpc /Tvs_3_0 /EVS /Fh Shader/EffekseerRenderer.Tool_VS.h Shader/tool_renderer_VS.fx
"%DXSDK_DIR%Utilities\\bin\x86\fxc" /Zpc /Tps_3_0 /EPS /Fh Shader/EffekseerRenderer.Tool_PS.h Shader/tool_renderer_PS.fx
"%DXSDK_DIR%Utilities\\bin\x86\fxc" /Zpc /Tps_3_0 /EPS /Fh Shader/EffekseerRenderer.ToolNoTexture_PS.h Shader/tool_renderer_no_texture_PS.fx
