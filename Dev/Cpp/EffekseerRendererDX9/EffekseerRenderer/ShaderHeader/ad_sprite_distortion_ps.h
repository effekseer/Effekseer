...
//
//   fxc /Zpc /Tps_3_0 /Emain /Fh ShaderHeader/ad_sprite_distortion_ps.h
//    Shader/ad_sprite_distortion_ps.fx
//
//
// Parameters:
//
...
//   _209_flipbookParameter               c2       1
//   _209_uvDistortionParameter           c3       1
//   _209_blendTextureParameter           c4       1
...
//
    ...
    mad r0.yw, r0.xxzz, c3.x, v1.xxzy
    texld r1, r0.ywzw, s0
    mul r1.z, r1.w, v0.w
    ...
    mul r0.xz, r0, v0.xyyw
    mul r0.xz, r0, c0.x
    mad r1.zw, v4.xyxy, r1.z, -r1.xyxy
    mad r1.zw, r1, r0.x, r1.xyxy
    mad r0.xw, v3.xyzy, r0.w, -r1.xyzy
    mad r0.xz, r0.xyww, r0.z, r1.zyww
    add r0.xz, r0, -c6.y
    mul r1.x, r0.x, c5.w
