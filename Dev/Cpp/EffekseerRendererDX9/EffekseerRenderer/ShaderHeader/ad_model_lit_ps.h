...
//   float4 _290_fBlendTextureParameter;
//   float4 _290_fCameraFrontDirection;
//   float4 _290_fEdgeColor;
//   float4 _290_fEdgeParameter;
//   float4 _290_fEmissiveScaling;
//   float4 _290_fFalloffBeginColor;
//   float4 _290_fFalloffEndColor;
//   float4 _290_fFalloffParameter;
//   float4 _290_fFlipbookParameter;
//   float4 _290_fLightAmbient;
//   float4 _290_fLightColor;
//   float4 _290_fLightDirection;
//   float4 _290_fUVDistortionParameter;
//   float4 _290_miscFlags;
//
//
// Registers:
//
//   Name                                 Reg   Size
//   ------------------------------------ ----- ----
//   _290_fLightDirection                 c0       1
//   _290_fLightColor                     c1       1
//   _290_fLightAmbient                   c2       1
//   _290_fFlipbookParameter              c3       1
//   _290_fUVDistortionParameter          c4       1
//   _290_fBlendTextureParameter          c5       1
//   _290_fCameraFrontDirection           c6       1
//   _290_fFalloffParameter               c7       1
//   _290_fFalloffBeginColor              c8       1
//   _290_fFalloffEndColor                c9       1
//   _290_fEmissiveScaling                c10      1
//   _290_fEdgeColor                      c11      1
//   _290_fEdgeParameter                  c12      1
//   _290_miscFlags                       c17      1
...
//
    ...
    texld r1, r0.ywzw, s0
    abs r2.x, c17.x
    max r2.yzw, r1_abs.xxyz, c13.z
    log r3.x, r2.y
    log r3.y, r2.z
    log r3.z, r2.w
    mul r2.yzw, r3.xxyz, c13.w
    exp r3.x, r2.y
    exp r3.y, r2.z
    exp r3.z, r2.w
    mad r2.yzw, r3.xxyz, c14.x, c14.y
    max r3.xyz, r2.yzww, c14.z
    cmp r1.xyz, -r2.x, r1, r3
    mul r1, r1, v0
    texld r3, r0.ywzw, s1
    add r2.yzw, r3.xxyz, c14.w
    add r2.yzw, r2, r2
    mul r3.xyz, r2.z, v3
    mad r3.xyz, r2.y, v4, r3
    mad r2.yzw, r2.w, v2.xxyz, r3.xxyz
    nrm r3.xyz, r2.yzww
    ...
    mul r0.w, r0.x, r1.w
    texld r4, v6.zwzw, s6
    mad r4.xy, r4, c13.x, c13.y
    mad r4.z, r4.y, -c4.w, c4.z
    mad r2.yz, r4.xxzw, c4.y, v7.xxyw
    texld r6, r2.yzzw, s4
    max r2.yzw, r6_abs.xxyz, c13.z
    log r7.x, r2.y
    log r7.y, r2.z
    log r7.z, r2.w
    mul r2.yzw, r7.xxyz, c13.w
    exp r7.x, r2.y
    exp r7.y, r2.z
    exp r7.z, r2.w
    mad r2.yzw, r7.xxyz, c14.x, c14.y
    max r7.xyz, r2.yzww, c14.z
    cmp r2.yzw, -r2.x, r6.xxyz, r7.xxyz
    mad r4.xy, r4.xzzw, c4.y, v6
    texld r4, r4, s5
    mul r1.w, r4.w, r4.x
    mul r1.w, r1.w, r6.w
    abs r3.w, c5.x
    mul r4.xyz, r1.w, r2.yzww
    lrp r6.xyz, r1.w, r2.yzww, r1
    mov r7.xyz, c15
    add r7.xyz, r7, c5.x
    mad r8.xyz, r2.yzww, r1.w, r1
    mad r2.yzw, r2, -r1.w, r1.xxyz
    mul r4.xyz, r1, r4
    cmp r1.xyz, -r7_abs.z, r4, r1
    cmp r1.xyz, -r7_abs.y, r2.yzww, r1
    cmp r1.xyz, -r7_abs.x, r8, r1
    cmp r1.xyz, -r3.w, r6, r1
    dp3 r1.w, c0, r3
    mul r2.yzw, r1.w, c1.xxyz
    cmp r2.yzw, r1.w, r2, c14.z
    add r2.yzw, r2, c2.xxyz
    mul r0.xyz, r1, r2.yzww
    add r4.xyz, -r5_abs.yyxw, c7.xyyw
    nrm r5.xyz, -c6
    dp3_sat r1.w, r5, r3
    pow r3.x, r1.w, c7.z
    mov r5, c9
    ...
    mad r3, r3.x, r5, c9
    abs r1.w, c7.y
    mad r5.xyz, r1, r2.yzww, r3
    mad r1.xyz, r1, r2.yzww, -r3
    mul r2.yzw, r0.xxyz, r3.xxyz
    cmp r2.yzw, -r4_abs.z, r2, r0.xxyz
    cmp r1.xyz, -r4_abs.y, r1, r2.yzww
    ...
    mad r1.xyz, r0, c16.x, c16.y
    mad r1.xyz, r0, r1, c16.z
    mul r1.xyz, r0, r1
    min r2.yzw, r1.xxyz, r0.xxyz
    cmp oC0.xyz, -r2.x, r0, r2.yzww
    mov oC0.w, r0.w
