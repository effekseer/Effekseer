...
//   float4 _187_fBlendTextureParameter;
//   float4 _187_fCameraFrontDirection;
//   float4 _187_fEdgeColor;
//   float4 _187_fEdgeParameter;
//   float4 _187_fEmissiveScaling;
//   
//   struct
//   {
//       float4 Param;
...
//   } _187_fFalloffParam;
//   
//   float4 _187_fFlipbookParameter;
//   float4 _187_fUVDistortionParameter;
//
//
// Registers:
//
//   Name                               Reg   Size
//   ---------------------------------- ----- ----
//   _187_fFlipbookParameter            c3       1
//   _187_fUVDistortionParameter        c4       1
//   _187_fBlendTextureParameter        c5       1
//   _187_fCameraFrontDirection         c6       1
//   _187_fFalloffParam                 c7       3
//   _187_fEmissiveScaling              c10      1
//   _187_fEdgeColor                    c11      1
//   _187_fEdgeParameter                c12      1
...
//
    ...
    cmp r1, -c3.x, r1, r2
    mad r0.xy, r0, c4.x, v3
    texld r0, r0, s2
    mul r0.x, r0.w, r0.x
    mul r0.w, r0.x, r1.w
    texld r2, v4.zwzw, s6
    mad r2.xy, r2, c0.x, c0.y
    mad r2.zw, r2.xyxy, c4.y, v5.xyxy
    texld r4, r2.zwzw, s4
    mad r2.xy, r2, c4.y, v4
    texld r2, r2, s5
    mul r1.w, r2.w, r2.x
    mul r1.w, r1.w, r4.w
    abs r2.x, c5.x
