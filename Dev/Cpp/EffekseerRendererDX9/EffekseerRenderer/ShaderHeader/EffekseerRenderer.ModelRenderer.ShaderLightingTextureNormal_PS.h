...
//   float4 _187_fLightAmbient;
//   float4 _187_fLightColor;
//   float4 _187_fLightDirection;
...
//   Name                               Reg   Size
//   ---------------------------------- ----- ----
//   _187_fLightDirection               c0       1
//   _187_fLightColor                   c1       1
//   _187_fLightAmbient                 c2       1
...
//
    ...
    cmp r1, -c3.x, r1, r2
    mad r0.xy, r0, c4.x, v5
    texld r0, r0, s2
    mul r0.x, r0.w, r0.x
    mul r0.w, r0.x, r1.w
    texld r2, v6.zwzw, s6
    mad r2.xy, r2, c13.x, c13.y
    mad r2.zw, r2.xyxy, c4.y, v7.xyxy
    texld r5, r2.zwzw, s4
    mad r2.xy, r2, c4.y, v6
    texld r2, r2, s5
    mul r1.w, r2.w, r2.x
    mul r1.w, r1.w, r5.w
    abs r2.x, c5.x
