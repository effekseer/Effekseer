...
//
    ...
    mad r1, c2, r0.z, r1
    mad o8, c3, r0.w, r1
    mad r1.xy, v3.yxzw, c44[a0.y].wzzw, c44[a0.y].yxzw
    mad r1.z, c138.y, r1.x, c138.x
    mul r2, v1.y, c5[a0.x]
    ...
    mov r3, c104
    if_lt c135.y, r3.x
      frc r1.x, c105[a0.y].x
      add r4.x, -r1.x, c105[a0.y].x
      ...
      rcp r4.z, c104.z
      rcp r4.w, c104.w
      mad r3.xy, r3.zwzw, -r4.zwzw, r1.yzzw
