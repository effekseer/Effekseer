...
//
    ...
    texld r0, v1, s0
    abs r1.x, c17.x
    max r1.yzw, r0_abs.xxyz, c3.x
    log r2.x, r1.y
    log r2.y, r1.z
    log r2.z, r1.w
    mul r1.yzw, r2.xxyz, c3.y
    exp r2.x, r1.y
    exp r2.y, r1.z
    exp r2.z, r1.w
    mad r1.yzw, r2.xxyz, c3.z, c3.w
    max r2.xyz, r1.yzww, c4.x
    cmp r0.xyz, -r1.x, r0, r2
    mul r0, r0, v0
    cmp r2, -r0_abs.w, c4.y, c4.z
    texkill r2
    texld r2, v1, s1
    add r1.yzw, r2.xxyz, c4.w
    add r1.yzw, r1, r1
    mul r2.xyz, r1.z, v3
    mad r2.xyz, r1.y, v4, r2
    mad r1.yzw, r1.w, v2.xxyz, r2.xxyz
    nrm r2.xyz, r1.yzww
    dp3 r1.y, c0, r2
    mul r2.xyz, r1.y, c1
    cmp r1.yzw, r1.y, r2.xxyz, c4.x
