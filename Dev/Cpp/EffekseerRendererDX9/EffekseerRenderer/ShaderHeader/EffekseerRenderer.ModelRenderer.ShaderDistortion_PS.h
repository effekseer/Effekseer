...
//   ---------------------------------- ----- ----
//   _187_g_scale                       c0       1
//   _187_mUVInversedBack               c1       1
//   _187_fFlipbookParameter            c2       1
//   _187_fUVDistortionParameter        c3       1
//   _187_fBlendTextureParameter        c4       1
...
//
    ...
    texld r1, r0.zwzw, s0
    mul r1.z, r1.w, v4.w
    mad r0.zw, r0.xyxy, c3.x, v7
    texld r2, r0.zwzw, s0
    mov r3.y, c6.y
    add r0.z, r3.y, c2.y
    mad r2.xyz, r2.xyww, v4.xyww, -r1
    mad r2.xyz, v8.x, r2, r1
    cmp r2.xyz, -r0_abs.z, r2, r1
    ...
    texkill r2
    texld r2, v6.zwzw, s6
    mad r0.xz, r2.xyyw, c6.x, c6.y
    mad r1.zw, r0.xyxz, c3.y, v7.xyxy
    texld r2, r1.zwzw, s4
    mad r0.xz, r0, c3.y, v6.xyyw
    texld r3, r0.xzzw, s5
    mul r0.x, r3.w, r3.x
    mul r0.x, r0.x, r2.w
    abs r0.z, c4.x
    mul r1.zw, r0.x, r2.xyxy
    lrp r3.xy, r0.x, r2, r1
    mov r4.xyz, c5
    add r4.xyz, r4, c4.x
    mad r2.zw, r2.xyxy, r0.x, r1.xyxy
    ...
    cmp r0.xz, -r0.z, r3.xyyw, r0.xyww
    rcp r0.w, v3.w
    mul r1.xy, r0.w, v3
    rcp r0.w, v2.w
    rcp r1.z, v1.w
