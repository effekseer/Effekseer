	...
	, m_shader		( shader )
{
	...
	{
		shaders[i]->SetVertexConstantBufferSize(sizeof(ModelRendererVertexConstantBuffer<40>));
		shaders[i]->SetVertexRegisterCount(sizeof(ModelRendererVertexConstantBuffer<40>)/(sizeof(float)*4));
		shaders[i]->SetPixelConstantBufferSize(sizeof(ModelRendererPixelConstantBuffer));
		shaders[i]->SetPixelRegisterCount(sizeof(ModelRendererPixelConstantBuffer)/(sizeof(float)*4));
	}
}
