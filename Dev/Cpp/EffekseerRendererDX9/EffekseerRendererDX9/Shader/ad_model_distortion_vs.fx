...
static const VS_Output _591 = { 0.0f.xxxx, 0.0f.xxxx, 0.0f.xxxx, 0.0f.xxxx, 0.0f.xxxx, 0.0f.xxxx, 0.0f.xxxx, 0.0f.xxxx, 0.0f.xxxx };

cbuffer VS_ConstantBuffer : register(b0)
{
    column_major float4x4 _451_mCameraProj : register(c0);
    column_major float4x4 _451_mModel_Inst[10] : register(c4);
    float4 _451_fUV[10] : register(c44);
    float4 _451_fAlphaUV[10] : register(c54);
    float4 _451_fUVDistortionUV[10] : register(c64);
    float4 _451_fBlendUV[10] : register(c74);
    float4 _451_fBlendAlphaUV[10] : register(c84);
    float4 _451_fBlendUVDistortionUV[10] : register(c94);
    float4 _451_flipbookParameter1 : register(c104);
    float4 _451_flipbookParameter2 : register(c105);
    float4 _451_fFlipbookIndexAndNextRate[10] : register(c106);
    float4 _451_fModelAlphaThreshold[10] : register(c116);
    float4 _451_fModelColor[10] : register(c126);
    float4 _451_fLightDirection : register(c136);
    float4 _451_fLightColor : register(c137);
    float4 _451_fLightAmbient : register(c138);
    float4 _451_mUVInversed : register(c139);
};
