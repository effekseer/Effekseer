...
static const VS_Output _144 = { 0.0f.xxxx, 0.0f.xx, 0.0f.xxxx, 0.0f.xxxx, 0.0f.xxxx, 0.0f.xxxx };
...
VS_Output _main(VS_Input Input)
{
    ...
    Output.ProjBinormal = mul(_119_mCameraProj, worldPos + worldBinormal);
    Output.ProjTangent = mul(_119_mCameraProj, worldPos + worldTangent);
