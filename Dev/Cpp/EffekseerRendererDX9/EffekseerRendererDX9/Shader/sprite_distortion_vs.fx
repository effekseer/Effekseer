...
{
    column_major float4x4 _80_mCamera : register(c0);
    column_major float4x4 _80_mCameraProj : register(c4);
    float4 _80_mUVInversed : register(c8);
    float4 _80_mflipbookParameter : register(c9);
};
