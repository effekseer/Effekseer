...
VS_Output _main(VS_Input Input)
{
    ...
    vec3 _111 = normalize(Input.Normal * lightMat);
    localNormal = vec4(_111.x, _111.y, _111.z, localNormal.w);
    vec4 localBinormal = vec4(0.0, 0.0, 0.0, 1.0);
    vec3 _118 = normalize(Input.Binormal * lightMat);
    localBinormal = vec4(_118.x, _118.y, _118.z, localBinormal.w);
    vec4 localTangent = vec4(0.0, 0.0, 0.0, 1.0);
    vec3 _125 = normalize(Input.Tangent * lightMat);
    localTangent = vec4(_125.x, _125.y, _125.z, localTangent.w);
