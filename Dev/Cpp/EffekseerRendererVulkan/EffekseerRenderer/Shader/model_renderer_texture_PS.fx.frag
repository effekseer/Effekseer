...
vec4 _main(PS_Input Input)
{
    ...
    vec3 _375 = Output.xyz * _187.fEmissiveScaling.x;
    Output = vec4(_375.x, _375.y, _375.z, Output.w);
    if (Output.w <= max(0.0, advancedParam.AlphaThreshold))
    {
        discard;
    }
    vec3 _406 = mix(_187.fEdgeColor.xyz * _187.fEdgeParameter.y, Output.xyz, vec3(ceil((Output.w - advancedParam.AlphaThreshold) - _187.fEdgeParameter.x)));
