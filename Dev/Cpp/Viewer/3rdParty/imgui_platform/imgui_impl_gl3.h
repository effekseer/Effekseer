...
IMGUI_API bool        ImGui_ImplGL3_Init(GLFWwindow* window, bool install_callbacks, const char* glsl_version = NULL);
IMGUI_API void        ImGui_ImplGL3_Shutdown();
IMGUI_API void        ImGui_ImplGL3_NewFrame();
IMGUI_API void        ImGui_ImplGL3_RenderDrawData(ImDrawData* draw_data);
