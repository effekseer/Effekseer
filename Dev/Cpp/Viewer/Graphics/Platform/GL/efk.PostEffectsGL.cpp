	...
	, renderer_(EffekseerRendererGL::RendererImplementedRef::FromPinned(renderer.Get()))
{
	...
	shaderExtract.reset(Shader::Create(renderer_->GetInternalGraphicsDevice(), &basicVS, 1, &extractPS, 1, "Bloom extract", true, true));
	...
	shaderDownsample.reset(Shader::Create(renderer_->GetInternalGraphicsDevice(), &basicVS, 1, &downSamplePS, 1, "Bloom downsample", true, true));
	...
	shaderBlend.reset(Shader::Create(renderer_->GetInternalGraphicsDevice(), &basicVS, 1, &blendPS, 1, "Bloom blend", true, true));
	...
	shaderBlurH.reset(Shader::Create(renderer_->GetInternalGraphicsDevice(), &basicVS, 1, &blend_h_PS, 1, "Bloom blurH", true, true));
	...
	shaderBlurV.reset(Shader::Create(renderer_->GetInternalGraphicsDevice(), &basicVS, 1, &blend_v_PS, 1, "Bloom blurV", true, true));
	...
	, renderer_(EffekseerRendererGL::RendererImplementedRef::FromPinned(renderer.Get()))
{
	...
	shaderCopy.reset(Shader::Create(renderer_->GetInternalGraphicsDevice(), &basicVS, 1, &copyPS, 1, "Tonemap copy", true, true));
	...
	shaderReinhard.reset(Shader::Create(renderer_->GetInternalGraphicsDevice(), &basicVS, 1, &tonemapPS, 1, "Tonemap Reinhard", true, true));
	...
	, renderer_(EffekseerRendererGL::RendererImplementedRef::FromPinned(renderer.Get()))
{
	...
	// Copy shader
	shader_.reset(Shader::Create(renderer_->GetInternalGraphicsDevice(), &basicVS, 1, &linierToSrgbPS, 1, "LinearToSRGB", true, true));
