...
void BlitterGL::Blit(EffekseerRendererGL::Shader* shader, EffekseerRendererGL::VertexArray* vao, int32_t numTextures, const GLuint* textures, const void* constantData, size_t constantDataSize, RenderTexture* dest, bool isCleared)
{
	...
	, blitter(graphics)
{
	...
	shaderExtract->AddPixelConstantLayout(CONSTANT_TYPE_VECTOR4,
										  shaderExtract->GetUniformId("u_FilterParams"),
										  0);
	shaderExtract->AddPixelConstantLayout(CONSTANT_TYPE_VECTOR4,
										  shaderExtract->GetUniformId("u_Intensity"),
										  16);
	...
	, blitter(graphics)
{
	...
	shaderReinhard.reset(Shader::Create(renderer,
										g_basic_vs_src,
										sizeof(g_basic_vs_src),
										g_tonemap_reinhard_fs_src,
										sizeof(g_tonemap_reinhard_fs_src),
										"Tonemap Reinhard"));
	...
	shaderReinhard->AddPixelConstantLayout(CONSTANT_TYPE_VECTOR4,
										   shaderReinhard->GetUniformId("u_Exposure"),
										   0);
