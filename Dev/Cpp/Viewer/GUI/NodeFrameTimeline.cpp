...
void NodeFrameTimeline::EndNodeFrameTimeline(int* frameMin, int* frameMax, int* currentFrame, int* selectedEntry, int* firstFrame)
{
	...
	ImGui::PopItemWidth();
	Sequencer(
		&mySequence, currentFrame, &expanded, selectedEntry, firstFrame, ImSequencer::SEQUENCER_EDIT_STARTEND | ImSequencer::SEQUENCER_ADD | ImSequencer::SEQUENCER_DEL | ImSequencer::SEQUENCER_CHANGE_FRAME);
