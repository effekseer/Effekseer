...
//
//----------------------------------------------------------------------------------
void RandObject::SetSeed(int32_t seed) { m_seed = seed; }

//----------------------------------------------------------------------------------
//
//----------------------------------------------------------------------------------
int32_t RandObject::GetRandInt() { return RandLCG(m_seed); }
...
//
//----------------------------------------------------------------------------------
float RandObject::GetRand(float min_, float max_) { return GetRand() * (max_ - min_) + min_; }
