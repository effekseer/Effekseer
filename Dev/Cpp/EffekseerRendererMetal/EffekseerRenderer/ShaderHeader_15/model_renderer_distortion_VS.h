...
VS_Output _main(VS_Input Input, constant VS_ConstantBuffer& v_27)
{
    ...
    Output.Position = v_27.mCameraProj * localPosition;
    Output.UV.x = (Input.UV.x * uv.z) + uv.x;
    Output.UV.y = (Input.UV.y * uv.w) + uv.y;
    Output.Normal = v_27.mCameraProj * localNormal;
    Output.Binormal = v_27.mCameraProj * localBinormal;
    Output.Tangent = v_27.mCameraProj * localTangent;
