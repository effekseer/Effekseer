...
fragment main0_out main0(main0_in in [[stage_in]], constant PS_ConstanBuffer& v_264 [[buffer(0)]], texture2d<float> g_uvDistortionTexture [[texture(3)]], texture2d<float> g_colorTexture [[texture(0)]], texture2d<float> g_normalTexture [[texture(1)]], texture2d<float> g_alphaTexture [[texture(2)]], texture2d<float> g_blendUVDistortionTexture [[texture(6)]], texture2d<float> g_blendTexture [[texture(4)]], texture2d<float> g_blendAlphaTexture [[texture(5)]], texture2d<float> g_depthTexture [[texture(7)]], sampler g_uvDistortionSampler [[sampler(3)]], sampler g_colorSampler [[sampler(0)]], sampler g_normalSampler [[sampler(1)]], sampler g_alphaSampler [[sampler(2)]], sampler g_blendUVDistortionSampler [[sampler(6)]], sampler g_blendSampler [[sampler(4)]], sampler g_blendAlphaSampler [[sampler(5)]], sampler g_depthSampler [[sampler(7)]], float4 gl_FragCoord [[position]])
{
    main0_out out = {};
    PS_Input Input;
    ...
    float4 _650 = _main(Input, g_uvDistortionTexture, g_uvDistortionSampler, v_264, g_colorTexture, g_colorSampler, g_normalTexture, g_normalSampler, g_alphaTexture, g_alphaSampler, g_blendUVDistortionTexture, g_blendUVDistortionSampler, g_blendTexture, g_blendSampler, g_blendAlphaTexture, g_blendAlphaSampler, g_depthTexture, g_depthSampler);
