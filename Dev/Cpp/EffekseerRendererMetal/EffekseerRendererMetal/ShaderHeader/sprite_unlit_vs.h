...
VS_Output _main(VS_Input Input, constant VS_ConstantBuffer& _39)
{
    ...
    Output.PosVS = _39.mCameraProj * worldPos;
...
vertex main0_out main0(main0_in in [[stage_in]], constant VS_ConstantBuffer& _39 [[buffer(0)]])
{
    main0_out out = {};
    VS_Input Input;
    ...
    VS_Output flattenTemp = _main(Input, _39);
