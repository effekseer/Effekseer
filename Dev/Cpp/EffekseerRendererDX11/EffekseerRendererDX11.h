...
public:
	...
	*/
	virtual const ::Effekseer::TextureRef& GetBackground();
	...
	*/
	virtual void SetBackground(::Effekseer::TextureRef texture);
	...
	*/
	virtual Effekseer::TextureRef CreateProxyTexture(ProxyTextureType type);
	...
	*/
	virtual void DeleteProxyTexture(Effekseer::TextureRef& texture);
	...
	*/
	virtual void GetDepth(::Effekseer::TextureRef& texture, DepthReconstructionParameter& reconstructionParam);
	...
	*/
	virtual void SetDepth(::Effekseer::TextureRef texture, const DepthReconstructionParameter& reconstructionParam);
