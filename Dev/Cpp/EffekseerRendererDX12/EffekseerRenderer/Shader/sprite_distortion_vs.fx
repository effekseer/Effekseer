...
{
    column_major float4x4 _63_mCamera : packoffset(c0);
    column_major float4x4 _63_mProj : packoffset(c4);
    float4 _63_mUVInversed : packoffset(c8);
    float4 _63_mflipbookParameter : packoffset(c9);
};
