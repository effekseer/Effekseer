...
cbuffer PS_ConstanBuffer : register(b1)
{
    ...
    float4 _210_fEmissiveScaling : packoffset(c6);
    float4 _210_fEdgeColor : packoffset(c7);
    float4 _210_fEdgeParameter : packoffset(c8);
};
...
float4 _main(PS_Input Input)
{
    ...
    ApplyFlipbook(param_3, g_colorTexture, g_colorSampler, _210_fFlipbookParameter, Input.VColor, advancedParam.FlipbookNextIndexUV + UVOffset, param_4);
    Output = param_3;
