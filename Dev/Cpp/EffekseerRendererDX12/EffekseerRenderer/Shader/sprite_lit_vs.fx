...
{
    column_major float4x4 _62_mCamera : packoffset(c0);
    column_major float4x4 _62_mProj : packoffset(c4);
    float4 _62_mUVInversed : packoffset(c8);
    float4 _62_mflipbookParameter : packoffset(c9);
};
