...
{
    column_major float4x4 _81_mCamera : packoffset(c0);
    column_major float4x4 _81_mCameraProj : packoffset(c4);
    float4 _81_mUVInversed : packoffset(c8);
    float4 _81_mflipbookParameter : packoffset(c9);
};
