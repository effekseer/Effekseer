...
namespace Effekseer.GUI.BindableComponent
{
	class DynamicSelector
	{
		...
		public static void SelectMaxInComponent(string id, Data.Value.DynamicEquationReference reference)
		{
			...
			var nextParam = ObjectCollection.Select(MultiLanguageTextProvider.GetText("Max"), id, reference.Value, false, Core.Dynamic.Equations);
		...
		public static void SelectMinInComponent(string id, Data.Value.DynamicEquationReference reference)
		{
			...
			var nextParam = ObjectCollection.Select(MultiLanguageTextProvider.GetText("Min"), id, reference.Value, false, Core.Dynamic.Equations);
