...
public struct EasingFloat : IFlatbufferObject
{
  ...
  public Effekseer.FB.RefMinMax? RefEqE { get { int o = __p.__offset(6); return o != 0 ? (Effekseer.FB.RefMinMax?)(new Effekseer.FB.RefMinMax()).__assign(__p.__indirect(o + __p.bb_pos), __p.bb) : null; } }
  public Effekseer.FB.RefMinMax? RefEqM { get { int o = __p.__offset(8); return o != 0 ? (Effekseer.FB.RefMinMax?)(new Effekseer.FB.RefMinMax()).__assign(__p.__indirect(o + __p.bb_pos), __p.bb) : null; } }
  ...
  public static void AddRefEqE(FlatBufferBuilder builder, Offset<Effekseer.FB.RefMinMax> refEqEOffset) { builder.AddOffset(1, refEqEOffset.Value, 0); }
  public static void AddRefEqM(FlatBufferBuilder builder, Offset<Effekseer.FB.RefMinMax> refEqMOffset) { builder.AddOffset(2, refEqMOffset.Value, 0); }
...
public struct EasingVec3F : IFlatbufferObject
{
  ...
  public Effekseer.FB.RefMinMax? RefEqE { get { int o = __p.__offset(6); return o != 0 ? (Effekseer.FB.RefMinMax?)(new Effekseer.FB.RefMinMax()).__assign(__p.__indirect(o + __p.bb_pos), __p.bb) : null; } }
  public Effekseer.FB.RefMinMax? RefEqM { get { int o = __p.__offset(8); return o != 0 ? (Effekseer.FB.RefMinMax?)(new Effekseer.FB.RefMinMax()).__assign(__p.__indirect(o + __p.bb_pos), __p.bb) : null; } }
  public Effekseer.FB.Vec3FRange? Start { get { int o = __p.__offset(10); return o != 0 ? (Effekseer.FB.Vec3FRange?)(new Effekseer.FB.Vec3FRange()).__assign(o + __p.bb_pos, __p.bb) : null; } }
  public Effekseer.FB.Vec3FRange? End { get { int o = __p.__offset(12); return o != 0 ? (Effekseer.FB.Vec3FRange?)(new Effekseer.FB.Vec3FRange()).__assign(o + __p.bb_pos, __p.bb) : null; } }
  public Effekseer.FB.Vec3FRange? Middle { get { int o = __p.__offset(14); return o != 0 ? (Effekseer.FB.Vec3FRange?)(new Effekseer.FB.Vec3FRange()).__assign(o + __p.bb_pos, __p.bb) : null; } }
  public Effekseer.FB.Easing3Type Type { get { int o = __p.__offset(16); return o != 0 ? (Effekseer.FB.Easing3Type)__p.bb.GetInt(o + __p.bb_pos) : Effekseer.FB.Easing3Type.StartEndSpeed; } }
  public float Params(int j) { int o = __p.__offset(18); return o != 0 ? __p.bb.GetFloat(__p.__vector(o) + j * 4) : (float)0; }
  public int ParamsLength { get { int o = __p.__offset(18); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  ...
  public static void StartEasingVec3F(FlatBufferBuilder builder) { builder.StartTable(12); }
  public static void AddRefEqS(FlatBufferBuilder builder, Offset<Effekseer.FB.RefMinMax> refEqSOffset) { builder.AddOffset(0, refEqSOffset.Value, 0); }
  public static void AddRefEqE(FlatBufferBuilder builder, Offset<Effekseer.FB.RefMinMax> refEqEOffset) { builder.AddOffset(1, refEqEOffset.Value, 0); }
  public static void AddRefEqM(FlatBufferBuilder builder, Offset<Effekseer.FB.RefMinMax> refEqMOffset) { builder.AddOffset(2, refEqMOffset.Value, 0); }
  public static void AddStart(FlatBufferBuilder builder, Offset<Effekseer.FB.Vec3FRange> startOffset) { builder.AddStruct(3, startOffset.Value, 0); }
  public static void AddEnd(FlatBufferBuilder builder, Offset<Effekseer.FB.Vec3FRange> endOffset) { builder.AddStruct(4, endOffset.Value, 0); }
  public static void AddMiddle(FlatBufferBuilder builder, Offset<Effekseer.FB.Vec3FRange> middleOffset) { builder.AddStruct(5, middleOffset.Value, 0); }
  public static void AddType(FlatBufferBuilder builder, Effekseer.FB.Easing3Type type) { builder.AddInt(6, (int)type, 0); }
  public static void AddParams(FlatBufferBuilder builder, VectorOffset paramsOffset) { builder.AddOffset(7, paramsOffset.Value, 0); }
  public static VectorOffset CreateParamsVector(FlatBufferBuilder builder, float[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddFloat(data[i]); return builder.EndVector(); }
  public static VectorOffset CreateParamsVectorBlock(FlatBufferBuilder builder, float[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
