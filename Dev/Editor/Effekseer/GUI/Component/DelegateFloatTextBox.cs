...
{
	class DelegateFloatTextBox : System.Windows.Forms.TextBox
	{
		public DelegateFloatTextBox()
		{
			Reading = false;
			Writing = false;
		...
		/// 書き込み関数
		/// </summary>
		/// <remarks>第1引数:値、第2引数:ホイールによる変更かどうか</remarks>
		public Action<float,bool> WriteMethod
		{
			get;
			set;
		}
