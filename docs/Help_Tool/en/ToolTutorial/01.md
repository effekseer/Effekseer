...
Effekseer is located in "Tool/Effekseer.dmg". Move Effekseer to other folder such as an Applications and double click the executable to start the program.
