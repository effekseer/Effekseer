...
|共通|Name|Line1|
|共通|Time to live|20|
|回転|Angle|x=0, y=0, z=-45|
|拡大|拡大方法|イージング|
|拡大|始点(中心)|x=4, y=1, z=1|
|拡大|終点(中心)|x=1, y=25, z=1|
|拡大|始点速度|高速3|
|拡大|終点速度|低速3|
|描画共通|Texture|Texture/Line01.png|
|描画共通|Blend|加算|
|描画|Configuration|Z軸回転ビルボード|
|描画|ColorAll|イージング|
|描画|ColorAll-始点(中心)|255,128,255,255|
|描画|ColorAll-終点(中心)|255,255,255,0|
|描画|ColorAll-始点速度|低速3|
|描画|ColorAll-終点速度|高速3|
...
|共通|Time to live|20|
|回転|回転方法|PVA|
|回転|Angle-Deviation|x=0, y=0, z=180|
|拡大|拡大方法|イージング|
...
|共通|Time to live|20|
|拡大|拡大方法|PVA(Single)|
|拡大|Expansion Speed|0.6|
|描画共通|Texture|Texture/Particle01.png|
|描画共通|Blend|加算|
|描画|ColorAll|イージング|
|描画|ColorAll-始点(中心)|255,32,255,255|
|描画|ColorAll-終点(中心)|255,128,255,0|
|描画|ColorAll-始点速度|低速3|
|描画|ColorAll-終点速度|高速3|
...
|:----|:----|:----|
|共通|Name|Flash2|
|描画共通|Texture|Texture/Particle03.png|
